...
BetBreaker additionally aims to leverage social connections to address a lack of mindfulness while participating in online gambling. Considering that this activity is largely considered a social form of entertainment, this led us to believe that implementing features that combatted impulsive decision-making would encourage individuals to know when to walk away from their betting platforms.
...
<ProjectImagesBlock
    images={[
        ...
        caption: "Bet Approval Screen"
        },
        {
        src: friends4,
        alt: "Every image requires alt text. This should describe the content of that image.",
        caption: "Users can have their bets approved anonymously."
        },
...
Our primary feature that overshadows this focus task is the ability to deny/accept one another's online bets before they are placed. This system intends to allow betting to be the unanimous decision of an online gambler's community, rather than the individual. In denying the placement of impulsive bets with highly negative ROIs, this BetBreaker system is designed to promote shared responsibility amongst peers and behavioral introspection among online gamblers themselves.
</ProjectImagesBlock>
...
<ProjectImagesBlock
    images={[
        ...
        src: friends5,
        alt: "Every image requires alt text. This should describe the content of that image.",
        caption: "Users can view which friends are online and recent bets."
        },
        {
        src: friends6,
        alt: "Every image requires alt text. This should describe the content of that image.",
        caption: "Friends Account Screen"
        },
        {
        src: friends7,
        alt: "Every image requires alt text. This should describe the content of that image.",
        caption: "Friend's Betting History"
        },
