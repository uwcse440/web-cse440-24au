...
<ProjectImageBlock
    ...
    caption={
        "Prepare Bear: a sympathetic companion that helps you processs and prepare through speech"
    }
    width={6}
    maxHeight={"325px"}
>
...
The way this is designed this system behind the scenes is through multiple dialogue trees that guide the user through
...
<ProjectImagesBlock
    images={[
        ...
        caption: "PB confirms with user that they are satisifed with their goals and the user now has a concrete plan forward"},
    ]}
    direction={"row"}
    width={12}
    maxHeight={"400px"}
...
To solve this issue, we conducted 3 research activities: two interviews with people who've had experience with therapy and
an online survey released to the online public receiving 36 responses, but with a large portion of responses coming 
from people with self-identified therapy experience. Our questions for all activities were structured around the two 
resultant research questions of "What barriers exist?" and "What makes communicating effective?". We targeted this 
demographic because we believed their experience with emotional communication would offer greater relevance and insight. 
We conducted interviews to gain insights from participants in the typical way, but also put out a survey to reach more 
people to verify our understanding of a serious topic that we didn't have expertise on. Through our research, we identified
...
expressed a real desire for some sort of tools that would help a person identify what they're feeling in preparation for
...
influenced our "Identifying Needs" dialgue tree's process of walking through emotions. The interviews talking about running
through conversations in their head motivated our "Prepare for a Conversation" dialgue tree as a practice and feedback session
...
in full stated “Yeah. I think it’s those two, and then just the guilt of worrying or stressing people around me.”  
This shaped our design direction by motivating us to include features that could ease this worry by specially considering who the
...
attempts to make the user feel more confident in how they'll converse with someone else.
...
Users should have methods for exiting or changing the current system status when they are
dissatisifed or are desiring a change. It was mainly from Usability Testing that many inspectors
...
<ProjectImageBlock
    image={
        {
            src: sympathytree,
            alt: "System for responding to user context.",
            caption: "New sympathy logic applicable to user context",
        }}
    width={12}
    maxHeight={"400px"}
>
...
Divergences from the main conversation tree are normal in a user interaction, and should be
supported, especially in cases where the user experience will benefit from the diversion. This
...
<ProjectImageBlock
    image={
        {
            src: questiontree,
            alt: "System for answering questions.",
            caption: "Logic for when user asks a question to Prepare Bear",
        }}
    width={12}
    maxHeight={"400px"}
>
