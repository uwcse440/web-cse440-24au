...
<ProjectImagesBlock
    ...
    caption="Facial system revisions aimed at showing user relevant system status, both when receiving input and loading, faces being used to deliver feedback in real time"
    direction={"column"}
    width={5}
>
...
This insight came mostly from usability testing, where across tests many system breaks occured when
