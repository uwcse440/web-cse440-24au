...
from intense emotions, which is done by talking through an event and defining goals with the system. 
The second is "Preparing What You're Going to Say" in a conversation with another person, which is done by iteratively 
